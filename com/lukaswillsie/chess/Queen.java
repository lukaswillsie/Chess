...
public class Queen extends Piece {
	...
	/**
	 * Create a new Queen of the given colour, at the given location on the given Board.
	 * 
	 * Note: before any computations are done, the newly created Queen should be added to
	 * board via the Board.addPiece() method
	 * 
	 * @param row - the row the new Queen is on
	 * @param column - the column the new Queen is on
	 * @param colour - the colour of the new Queen
	 * @param board - the Board that this Queen has been placed on
	 */
