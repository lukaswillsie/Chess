...
public class Board {
	...
	/**
	 * Return this Board's "save file". That is, what the contents of this board's save file
	 * WOULD be if saveGame() were called at this moment, where each item in the returned list
	 * of Strings is a line of the file
	 * 
	...
	/**
	 * Get this board's "save data". That is, returns a list of data like
	 * what would be saved in this Board's data file, as described in the Javadoc,
	 * if it were saved right now. Differs from getSaveFile() in that the data points
	 * that are numeric, like the boolean values at the beginning and the state flag
	 * at the end, are returned as Integers, not Strings.
	 * 
	 * @return A List of Objects representing the data that makes up this Board in its
	 * current state 
	 */
