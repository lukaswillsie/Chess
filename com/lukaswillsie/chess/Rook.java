...
public class Rook extends Piece {
	...
	/**
	 * Create a new Rook of the given colour, at the given location on the given Board.
	 * 
	 * Note: before any computations are done, the newly created Rook should be added to
	 * board via the Board.addPiece() method
	 * 
	 * @param row - the row the new Rook is on
	 * @param column - the column the new Rook is on
	 * @param colour - the colour of the new Rook
	 * @param board - the Board that this Rook has been placed on
	 */
